...
def main():
    ...
    parser.add_argument("day", help="The day of the month this happened on.")
    ...
    date = "2024-10-" + args.day;
    full_date = date + " " + datetime.now().strftime("%H:%M:%S") + " +0100"
    ...
    output_content = output_content.replace("tags: [film reviews, horror]", "tags: [film reviews, horror, spooktober 2024]")
